...
namespace AppManager.Api.Mapping
{
    public class MappingEngine : IMappingEngine
    {
        ...
        public MappingEngine(IEnumerable<Assembly> assembliesToScan, ILogger<MappingEngine> logger )
        {
            ...
            {
                // seems like automapper now uses AddMaps instead of AddProfiles
        ...
        public TDestiny Map<TSource, TDestiny>(TSource source)
        {
            ...
            catch (AutoMapperMappingException ex) //why not catch all exceptions? simple we don't know how to handle them all
            {
